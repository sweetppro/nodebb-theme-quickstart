...
$(document).ready(function () {
	...
	function togglePointerEvents() {
		var wrapper = document.getElementById('sweetp-wrapper');

		if (wrapper.classList.contains('disabled-pointer')) {
			wrapper.classList.remove('disabled-pointer');
		} else {
			wrapper.classList.add('disabled-pointer');
		}
	}
